...
Console.WriteLine("Time in the Cavern");
...
public class Pit : Room
{
    ...
    public bool IsAdjacent(Position position)
    {
        ...
        {
            if (position.Column == (Position.Column + 1) || position.Column == (Position.Column - 1))
            {
                isAjacent = true;
            }
        }
        else if (Position.Column == position.Column)
        {
            if (position.Row == (Position.Row + 1) || position.Row == (Position.Row - 1))
            {
                isAjacent = true;
            }
        }
